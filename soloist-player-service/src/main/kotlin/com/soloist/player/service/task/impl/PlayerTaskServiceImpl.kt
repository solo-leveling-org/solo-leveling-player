...
import com.soloist.player.exception.AccessDeniedException
...
import com.soloist.player.model.entity.task.PlayerTaskProps
import com.soloist.player.model.entity.task.dto.CompletePlayerTaskView
import com.soloist.player.model.entity.task.dto.GeneratePlayerTaskView
import com.soloist.player.model.entity.player.dto.GenerateTasksPlayerView
import com.soloist.player.model.entity.task.dto.PreparingPlayerTaskView
import com.soloist.player.model.entity.task.dto.SkipPlayerTaskView
...
class PlayerTaskServiceImpl(
	...
	override fun skipTask(playerId: Long, id: UUID) {
		...
		val consumedStamina = staminaService.consume(
			player.stamina.toEntity(),
			tasksProperties.getSkipCost()
		)
		staminaService.update(consumedStamina)
	...
	override fun completeTask(
		playerId: Long,
		id: UUID
	): Pair<CompleteTaskPlayerView, CompleteTaskPlayerView> {
		...
		val updatedStamina = staminaService.consume(
			player.stamina.toEntity(),
		...
		val updatedBalance = balanceService.deposit(
	...
	private fun filterPlayerTopics(
		player: Player,
		topics: Collection<TaskTopic>
	): CompleteTaskPlayerView = CompleteTaskPlayerView(Immutables.createPlayer(player) {
