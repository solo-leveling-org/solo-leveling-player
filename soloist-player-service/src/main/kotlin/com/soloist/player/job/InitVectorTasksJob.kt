...
class InitVectorTasksJob(
	...
	override fun runJob() {
		val jobWatch = StopWatch("init-vector-tasks").apply { start("total") }
		...
		try {
			...
			log.info(
				"Vector tasks init job timing: totalTasks={}, pages={}, totalTimeMs={}, details={}",
